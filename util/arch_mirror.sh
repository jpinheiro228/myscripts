...
source_url='rsync://pkg.adfinis-sygroup.ch/archlinux/'
#source_url='rsync://cluster.gtel.ufc.br/arch_mirror/'
# An HTTP(S) URL pointing to the 'lastupdate' file on your chosen mirror.
# If you are a tier 1 mirror use: http://rsync.archlinux.org/lastupdate
# Otherwise use the HTTP(S) URL from your chosen mirror.
lastupdate_url='http://pkg.adfinis-sygroup.ch/archlinux/lastupdate'
